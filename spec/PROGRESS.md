...
| M4-T4 | todo | — | — | M4-T3-a | perf pass + G4; includes the per-event **branchless-kernel split** (warp divergence) deferred by M4-T2-b, the event-based transport inside the eigen, and Nsight FP64-fraction ≤ 1% |
